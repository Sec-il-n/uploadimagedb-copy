...
<!-- <FORM ACTION ="/upload_image_db/FileUpload" METHOD="post" ENCTYPE="MULTIPART/FORM-DATA"> -->
<FORM ACTION ="/TmpFileUpload" METHOD="post" ENCTYPE="MULTIPART/FORM-DATA">
<%-- <textarea name="title" rows="2" cols="35"><c:out value="${title}"/></textarea><br> --%>
<div class="form-group">
    <label for="Inputtitle">Title:</label>
		<c:if test="${not empty checkTitle}">
		<div class="alert alert-danger" role="alert">
		<c:out value="${checkTitle}"/></div></c:if>
	<textarea class="form-control" name="title" id="FormControlTextarea1"><c:out value="${title}"/></textarea><br>
...
<div class="form-group">
    <label for="FormControlTextarea1">Comment:</label>
		...
		<div class="alert alert-danger" role="alert">
		<c:out value="${checkText}"/></div></c:if>
    <textarea class="form-control" name="text" id="FormControlTextarea1"><c:out value="${text}"/></textarea><br>


    <label for="FormControlTextarea1">Data:</label>
		<c:if test="${not empty checkFile}">
		<div class="alert alert-danger" role="alert">
		<c:out value="${checkFile}"/></div></c:if>
