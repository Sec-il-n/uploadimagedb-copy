...
<div class="jumbotron">
<form action="/RegisterEdit" method="post" name="register_edit_form">
	...
	<div class="form-group">
		...
		<input type="password" class="form-control" name="pass" id="pass" value="${account.pass}"><br>
	</div>
	<div class="form-group">
	    <label for="namela">Name</label>
		<input type="text" class="form-control" name="name" id="name" value="${account.name}"><br>
	</div>
	<div class="form-group">
