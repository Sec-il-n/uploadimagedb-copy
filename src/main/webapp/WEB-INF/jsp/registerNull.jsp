...
<title>Register form null</title>
...
<form action="/RegisterServlet" method="post" name="input_null_form">
<div class="form-group">
		<label for="userIdla">User ID</label>
		<c:if test="${not empty checkUserId}">
		<div class="alert alert-danger" role="alert">
		<c:out value="${checkUserId}"/></div></c:if><br>
	<input type="text" class="form-control" name="userId" value="${account.userId}"><br>
</div>
<div class="form-group">
	...
	<input type="password" class="form-control" name="pass" value="${account.pass}"><br>
</div>
<div class="form-group">
...
<input type="text" class="form-control" name="name" value="${account.name}"><br>
</div>
<div class="form-group">
	...
	<input type="text" class="form-control" name="age" value="${account.age}"><br>
</div>
