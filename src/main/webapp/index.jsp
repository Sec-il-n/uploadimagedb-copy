...
<meta name="author" content="">
    <title>Welcome to Your Picture*s Blog</title>
...
<c:if test="${not empty msg}" >
  ...
  <a class="btn btn-outline-info btn-lg" href="/RegisterServlet" role="button">Register account</a>
 	...
 	<!-- <a href="/upload_image_db4/LoginServlet" id="login">簡単Login</a>
 	<a href="/upload_image_db4/RegisterServlet" id="register">Register</a> -->
 <!-- Footer -->
